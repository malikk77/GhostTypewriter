...
public final class TypewriterLabel: UILabel {
    ...
    public var typingTimeInterval: TimeInterval = 0.01
    ...
    public func startTypewritingAnimation(completion: TypewriterLabelCompletion? = nil) {
        ...
        let int = String.Index(utf16Offset: 0, in: "")
            let characterIndex = attributedText.string.index(attributedText.string.startIndex ?? int, offsetBy: self.currentCharacterOffset)                                                                                                              
